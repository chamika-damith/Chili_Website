            ...
            <div className="grid md:grid-cols-3 gap-[20px] md:gap-0 items-end">
              ...
              <div className="ml-[10px] md:ml-[50px] lg:ml-[100px]">
                ...
                <div className="sm:flex  items-center gap-2 lg:gap-6">
                  ...
                  Spices</h1>
                  <div className="animate-fade-in ml-[20px] sm:ml-0 my-2 sm:my-0" style={{ animationDelay: '0.3s' }}>
                    <Brownbutton />
                  </div>
                </div>
                ...
                <div className="animate-fade-in ml-[20px] sm:ml-0 my-4" style={{ animationDelay: '0.3s' }}>
                    <Contact />
                  </div>
              </div>
